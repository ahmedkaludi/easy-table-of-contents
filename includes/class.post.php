	...
	private function processPages() {
		...
		if ( in_array( 'js_composer_salient/js_composer.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
			...
			if(!empty($eztoc_post_meta) && !empty($eztoc_post_id) && isset($eztoc_post_meta[$eztoc_post_id])){
                ...
                } else if ( ( in_array( 'advanced-custom-fields/acf.php', apply_filters('active_plugins', get_option( 'active_plugins') ) ) || in_array( 'advanced-custom-fields-pro/acf.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) && function_exists( 'ezTOC_getACFContentbyPost' ) && true == ezTOC_Option::get( 'acf-support', false ) ) {
