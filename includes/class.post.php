...
class ezTOC_Post {
	...
	private function applyContentFilter() {
		...
		remove_filter( 'the_content', array( 'ezTOC', 'the_content' ), 100 );
                ...
                if ( stripos($this->post->post_content, '[CARFORM]') !== false || strpos($this->post->post_content, '<!-- wp:block {"ref":') !== false || in_array( 'basic-user-avatars/init.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) && has_shortcode( $this->post->post_content, 'basic-user-avatars' ) || in_array( 'js_composer_salient/js_composer.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
