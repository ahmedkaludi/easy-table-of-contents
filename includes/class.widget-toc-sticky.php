    ...
    class ezTOC_WidgetSticky extends WP_Widget
    {
        ...
        public function __construct()
        {
            ...
            parent::__construct(
                    ...
                    __( 'Table of Contents Sticky', 'easy-table-of-contents' ),
                    $options
            );
        ...
        public function widget( $args, $instance )
        {
            ...
            if ( $post->hasTOCItems() )
            {
                ...
                wp_register_style( 'ez-toc-widget-sticky', EZ_TOC_URL . "assets/css/ez-toc-widget-sticky$min.css",
                        ( ! ezTOC_Option::get( 'exclude_css' ) ) ? array( 'ez-toc' ) : array(),
                        $widgetCSSVersion );
                wp_enqueue_style( 'ez-toc-widget-sticky', EZ_TOC_URL . "assets/css/ez-toc-widget-sticky$min.css",
                        ( ! ezTOC_Option::get( 'exclude_css' ) ) ? array( 'ez-toc' ) : array(),
                        $widgetCSSVersion );
                ...
                wp_register_script( 'ez-toc-widget-stickyjs', EZ_TOC_URL . "assets/js/ez-toc-widget-sticky$min.js",
                        ( ! ezTOC_Option::get( 'exclude_css' ) ) ? array( 'ez-toc-js' ) : array(),
                        $widgetJSVersion );
                wp_enqueue_script( 'ez-toc-widget-stickyjs', EZ_TOC_URL . "assets/js/ez-toc-widget-sticky$min.js",
                        ( ! ezTOC_Option::get( 'exclude_css' ) ) ? array( 'ez-toc-js' ) : array(),
                        $widgetJSVersion );
            }
        }
