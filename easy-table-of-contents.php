		...
		private static function maybeApplyTheContentFilter() {
			...
			return apply_filters( 'ez_toc_maybe_apply_the_content_filter', $apply );
                ...
                public static function isCoreLevel() {
                    if( 
                            in_array( 'divi-machine/divi-machine.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) 
                            || 'Pale Moon' == ez_toc_get_browser_name() 
                            || 'Fortunato Pro' == apply_filters( 'current_theme', get_option( 'current_theme' ) ) 
//                            || in_array( 'elementor-pro/elementor-pro.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) 
                            ...
                            || in_array( 'beaver-builder-lite-version/fl-builder.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) 
                    ) {
                        return true;
                    }
                    return false;
